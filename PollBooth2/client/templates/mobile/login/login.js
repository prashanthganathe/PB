    ...
    'click #btnlogin': function(event) {
        ...
        Meteor.loginWithPassword(email, password, function(err, result) {
            if (err) {
                ...
                Bert.alert('Login Failed. please try again.', 'danger', 'fixed-top', 'fa-frown-o');
            } else {
                // sAlert.success('Successfully Loggedin.');
                // FlowRouter.redirect('/postloginhome');
                Bert.alert('Login Success!', 'success', 'fixed-top', 'fa-frown-o');
